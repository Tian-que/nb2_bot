...
async def get_member():
    ...
    # 载入玩家token
    fig_dir = os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'player_info.json')
    player_info = await readTo(fig_dir)

    # 连接sqllit本地数据库
    fig_dir = os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'zh.sqllit3')
...
async def info_to_img(name):
    material_dir = os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'image', 'material')
    img = Image.open(material_dir + '\枪酱模组2.png')
    drawobj = ImageDraw.Draw(img)
    font = ImageFont.truetype(material_dir + '\msyhbd.ttc', 35)

    figName = name[0][0].replace('/', '_')
    img_url = os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'image', 'mod', figName)
    ...
    dirs = os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'image', 'everyday_mod')
...
async def get_perks(name):
    ...
    for id in ids:
        try:
            ret_dir = os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'image', 'weapon_perk', '{}.png').format(id)
            # print(ret_dir)
...
# ----------------------item_header部分---------------------------
    ...
    weapon_icon = {
        ...
        'figurl': icon[1]['src'],
        'figdir': os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'image', 'weapons')
    }
    ...
    async def make_p1():
        ...
        fontdir = os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'image', 'material', 'msyhbd.ttc')
    ...
    s_perks_1 = {
        ...
        "figurl": txt[0]['src'],
        'figdir': os.path.join(os.getcwd(), 'nb2_bot', 'data', 'destiny2', 'image', 'perks'),
